...
import { Eye, EyeOff, MessageCircle, ArrowLeft, Mail, Lock, User, Check } from 'lucide-react'
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        Username: formData.Username || formData.fullName.replace(/\s+/g, '').toLowerCase(),
        ...
        >
          <div className="sidebar-content">
            ...
            <div className="sidebar-welcome">
              <h1>Join PalAi Today!</h1>
              <p>Create your account and start having meaningful conversations with AI</p>
            </div>
            ...
            <div className="sidebar-cta">
              <p>Join over 10,000+ users who trust PalAi</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="auth-form-wrapper">
            <div className="form-header">
              ...
              <p>Get started with your free PalAi account</p>
            </div>
  ...
  <style jsx>{`
        ...
        .auth-container {
          ...
          overflow: hidden;
          display: grid;
          /* make left sidebar smaller so the form has more room */
        ...
        .auth-sidebar {
          ...
          color: white;
          /* slightly smaller padding to visually shrink the left pane */
        ...
        .form-header {
          ...
          .form-input {
            width: 100%;
            padding: 1.2rem 1.2rem; /* larger hit target */
            min-height: 56px;
            border-radius: 12px;
